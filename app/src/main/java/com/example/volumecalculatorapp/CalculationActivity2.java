...
public class CalculationActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cylinder cylinder = new Cylinder(shapeImg, shapeName);
        btnCalculate.setOnClickListener(v -> {
            ...
            double resultValue = cylinder.CalculateVolume(input1, input2);
